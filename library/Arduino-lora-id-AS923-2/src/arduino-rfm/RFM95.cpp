...
void RFM_Change_Channel(unsigned char Channel)
{
	...
	{
    #ifdef AS_923
		// case 0x00: //Channel 0 920.100 MHz / 61.035 Hz = 15125748 = 0xE6CCF3
		// // // ID920
  //     RFM_Write(0x06,0xE6);
  //     RFM_Write(0x07,0x06);
  //     RFM_Write(0x08,0xBD);
  //   break;
  //   case 0x10: //Receive channel 920.900 MHz / 61.035 Hz = 15125748 = 0xE6CCF3
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x39);
		// 	RFM_Write(0x08,0xC0);
  //     break;
  //   case 0x01: //Channel 1 920.300 MHz / 61.035 Hz = 15129024 = 0xE6D9C0
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x13);
		// 	RFM_Write(0x08,0x5A);
  //     break;
		// case 0x02: //Channel 2 920.500 MHz / 61.035 Hz = 15132301 = 0xE6E68D
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x20);
		// 	RFM_Write(0x08,0x27);
  //     break;
		// case 0x03: //Channel 3 920.700 MHz / 61.035 Hz = 15135578 = 0xE6F35A
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x2C);
		// 	RFM_Write(0x08,0xF3);
  //     break;
		// case 0x04: //Channel 4 920.900 MHz / 61.035 Hz = 15138855 = 0xE70027
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x39);
		// 	RFM_Write(0x08,0xC0);
  //     break;
		// case 0x05: //Channel 5 921.100 MHz / 61.035 Hz = 15142132 = 0xE70CF4
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x46);
		// 	RFM_Write(0x08,0x8D);
  //     break;
		// case 0x06: //Channel 6 921.300 MHz / 61.035 Hz = 15145408 = 0xE719C0
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x53);
		// 	RFM_Write(0x08,0x5A);
  //     break;
		// case 0x07: //Channel 7 921.500 MHz / 61.035 Hz = 15148685 = 0xE7268D
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x60);
		// 	RFM_Write(0x08,0x27);
  //     break;
		// case 0x08: //Channel 8 921.700 MHz / 61.035 Hz = 15151962 = 0xE7335A
		// 	RFM_Write(0x06,0xE6);
		// 	RFM_Write(0x07,0x6C);
		// 	RFM_Write(0x08,0xF3);
  //     break;

      //FREKUENSI INDONESIA AS923-2
    case 0x00: //Channel 0 921.200 MHz / 61.035 Hz = 15125748 = 0xE6CCF3
      // // ID920
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0x4C);
      RFM_Write(0x08, 0xF3);
      break;
    case 0x10: //Receive channel 921.400 MHz / 61.035 Hz = 15125748 = 0xE6CCF3
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0x59);
      RFM_Write(0x08, 0xC0);
      break;
    case 0x01: //Channel 1 921.400 MHz / 61.035 Hz = 15129024 = 0xE6D9C0
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0x59);
      RFM_Write(0x08, 0xC0);
      break;
    case 0x02: //Channel 2 921.600 MHz / 61.035 Hz = 15132301 = 0xE6E68D
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0x66);
      RFM_Write(0x08, 0x8D);
      break;
    case 0x03: //Channel 3 921.800 MHz / 61.035 Hz = 15135578 = 0xE6F35A
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0x73);
      RFM_Write(0x08, 0x5A);
      break;
    case 0x04: //Channel 4 922.000 MHz / 61.035 Hz = 15138855 = 0xE70027
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0x80);
      RFM_Write(0x08, 0x27);
      break;
    case 0x05: //Channel 5 922.200 MHz / 61.035 Hz = 15142132 = 0xE70CF4
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0x8C);
      RFM_Write(0x08, 0xF3);
      break;
    case 0x06: //Channel 6 922.400 MHz / 61.035 Hz = 15145408 = 0xE719C0
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0x99);
      RFM_Write(0x08, 0xC0);
      break;
    case 0x07: //Channel 7 922.600 MHz / 61.035 Hz = 15148685 = 0xE7268D
      RFM_Write(0x06, 0xE6);
      RFM_Write(0x07, 0xA6);
      RFM_Write(0x08, 0x8D);
      break;
