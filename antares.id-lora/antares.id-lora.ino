...
//ABP Credentials
const char *devAddr = "antares.id_loradeviceaddress";
// antares.id_accesskey xxxxxxxxxxxxxxxx:xxxxxxxxxxxxxxxx
const char *nwkSKey = "xxxxxxxxxxxxxxxx0000000000000000";
const char *appSKey = "0000000000000000xxxxxxxxxxxxxxxx";

const unsigned long interval = 600000;    // 30 min interval to send message
